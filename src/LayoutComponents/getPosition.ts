...
type Positions = { left: number; top: number }

const makeRect = ({ width, height }: Dimensions, { left, top }: Positions) => {
 ...
 * @return {Boolean}
 */
const getFitsOnBottom = (rect: ClientRect, viewport: Dimensions, viewportOffset: number) => {
 ...
 */
const getFitsOnRight = (rect: ClientRect, viewport: Dimensions, viewportOffset: number) => {
